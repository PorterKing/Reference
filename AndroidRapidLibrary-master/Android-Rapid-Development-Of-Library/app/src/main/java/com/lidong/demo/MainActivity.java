 ...
 * 主页面
 */
public class MainActivity extends BaseActivity implements SwichLayoutInterFace, BottomNavigationBar
    ...
    private void initData() {
        ...
        bottomNavigationBar
                .addItem(new BottomNavigationItem(R.mipmap.ic_location_on_white_24dp, "UI").setActiveColor(R.color
                        .orange))
                .addItem(new BottomNavigationItem(R.mipmap.ic_find_replace_white_24dp, "网络").setActiveColor(R.color
                        .blue))
